...
% 定义文档和代码环境
\newenvironment{docscode}{%
    \begin{paracol}{2}
    \setcolumnwidth{0.47\textwidth,0.53\textwidth}
    \sloppy  % 防止文字溢出
}{%
    \end{paracol}
}
...
\definecolor{keywordcolor}{RGB}{175,0,219}
...
\newcommand{\NumberTok}[1]{\textcolor{numbercolor}{#1}}
...
\lstdefinelanguage{go}{
    ...
    keywordstyle=\color{keywordcolor}\bfseries,
    ndkeywords={append,cap,close,complex,copy,delete,imag,len,make,new,panic,
                print,println,real,recover},
    ndkeywordstyle=\color{keywordcolor},
    sensitive=true,
    morecomment=[l]{//},
    morecomment=[s]{/*}{*/},
    morestring=[b]",
